...
static const char *fonts[]          = { FONT":size=12:antialias=true:autohint=true", "Noto Color Emoji:size=8.5:antialias=true:autohint=true" };
static const char dmenufont[]       = FONT":size=10:antialias=true:autohint=true";
...
/* tagging */
static const char *tags[] = { "", "󰈹", "󰓓", "󰲌", "", "󰙯" };
